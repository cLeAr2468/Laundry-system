                        ...
                        <CardContent className="space-y-3 md:space-y-4 p-4 md:p-6">
                            ...
                            <div className='flex flex-col md:flex-row items-center justify-center gap-2'>
                                ...
                                <div className="space-y-2 w-full">
                                    <select
                                        id="role"
                                        className="bg-gray-300 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base h-10 md:h-12 w-full"
                                        defaultValue=""
                                    >
